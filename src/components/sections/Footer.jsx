          ...
          <div className="md:col-span-6 flex flex-col md:items-end">
            <div className="grid grid-cols-2 gap-12">
              <div className="flex flex-col gap-4">
                ...
                <a href="/#problem" className="text-sm text-canvas/60 hover:text-coral transition-colors">Vision</a>
                <a href="/#architecture" className="text-sm text-canvas/60 hover:text-coral transition-colors">Platform</a>
                <a href="/#mvp" className="text-sm text-canvas/60 hover:text-coral transition-colors">Roadmap</a>
              </div>
              <div className="flex flex-col gap-4">
                <h4 className="font-semibold text-canvas mb-2 tracking-wide">Company</h4>
                <a href="/#about" className="text-sm text-canvas/60 hover:text-coral transition-colors">About Us</a>
                <a href="/#contact" className="text-sm text-canvas/60 hover:text-coral transition-colors">Contact</a>
              </div>
            </div>
          </div>
        </div>

        {/* Mega Typography Marquee */}
        <div className="w-full border-t border-canvas/10 pt-16 mb-8 overflow-hidden flex whitespace-nowrap">
